...
export default function BoardToolbar({
  ...
  return (
    <div className="relative md:sticky md:top-0 md:z-20 bg-page/95 backdrop-blur-md py-2 md:py-2.5 -mx-4 px-4 md:-mx-8 md:px-8 lg:-mx-10 lg:px-10 border-b border-border-subtle/70 mb-2.5 md:mb-4 transition-all">
      <div className="flex flex-col gap-2 md:gap-2.5">
        ...
        <div className="flex items-center justify-between gap-2 md:gap-3">
            ...
            {contentTypes.map((type) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 md:px-3.5 py-1 rounded-lg text-xs font-bold transition-all shrink-0 cursor-pointer ${
                    isActive
          ...
          <div className="flex items-center gap-1.5 shrink-0 ml-auto">
            {showSearch ? (
              <div className="relative w-36 sm:w-48 md:w-60 animate-fade-in flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-6 py-1 rounded-lg bg-surface border border-border-subtle text-text-primary placeholder:text-text-secondary/50 text-xs font-medium focus:outline-none focus:border-primary/50 transition-colors shadow-2xs"
                />
                <button
                  onClick={() => {
                    onSearchChange('');
              ...
              <button
                ...
                className="p-1.5 rounded-lg text-text-secondary hover:text-text-primary hover:bg-surface-elevated transition-colors cursor-pointer flex items-center gap-1 text-xs font-medium"
                title="Search posts"
        ...
        {/* Bottom Row: Filter Chips with Horizontal Scroll and Right-Edge Fade Indicator on Mobile */}
        <div className="relative w-full">
          <div className="flex items-center gap-2 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden py-0.5 text-xs pr-6 md:pr-0">
            {/* Platform ▾ */}
          ...
          {/* Subtle right-edge gradient fade indicator on mobile to hint at scrollable filters */}
          <div className="md:hidden pointer-events-none absolute right-0 top-0 bottom-0 w-6 bg-gradient-to-l from-page to-transparent" />
        </div>
      </div>
    </div>
  );
